...
from utils.commands.dota.helpers import VerifySteamView

async def handle_connect(ctx: commands.Context, account_id: int):
    ...
    view = VerifySteamView(author_id=ctx.author.id, account_id=account_id, verify_code=verify_code)
